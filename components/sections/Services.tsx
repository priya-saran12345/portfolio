...
export default function Services() {
  return (
    <section id="services" className="relative bg-surface border-t border-border py-24 md:py-32">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-border">
          {services.map((service, i) => (
            <motion.div
              ...
              className="bg-surface p-8 flex flex-col justify-between min-h-[220px] group hover:bg-surface2 transition-colors"
            >
              <div>
